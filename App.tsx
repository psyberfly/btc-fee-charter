...
//import { MovingAverageChartPage } from './moving_average_chart';
...
export function App() {
  return (
    <Router>
      <Routes>
        <Route path="/feeIndex" element={<FeeIndexChartPage />} />
        <Route path="/movingAverage" element={<MovingAverageChartPage />} />
